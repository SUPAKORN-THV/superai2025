<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2">
        <div class="bg-white rounded-lg shadow-sm border">
          ...
          <div class="p-6">
            <div v-if="loadingAttempts" class="space-y-4">
            ...
            <div v-else-if="recentAttempts.length === 0" class="text-center py-8">
            ...
            <div v-else class="space-y-4">
              ...
              >
                <div>
                  <h3 class="font-medium text-gray-900">{{ attempt.quiz?.title || 'Unknown Quiz' }}</h3>
                  <p class="text-sm text-gray-600">
                    {{ attempt.quiz?.language || 'Unknown' }} • {{ attempt.quiz?.difficulty || 'Unknown' }}
                  </p>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div class="space-y-3">
            ...
            <button
              ...
              @click="showAdminCreation = true"
              class="block w-full bg-purple-600 text-white text-center py-2 px-4 rounded-md hover:bg-purple-700 transition duration-300"
            >
    ...
    <div v-if="showAdminCreation" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-6 w-full max-w-md">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Create Admin Account</h3>
        <form @submit.prevent="createAdmin" class="space-y-4">
          ...
          <div>
            ...
            />
            <p class="text-xs text-gray-500 mt-1">Contact system administrator for the secret key</p>
          </div>
          
          <div v-if="adminError" class="text-red-600 text-sm">
            {{ adminError }}
          </div>
...
const showAdminCreation = ref(false)
...
const createAdmin = async () => {
  ...
  try {
    const response = await api.post('/api/users/create-admin', adminForm.value)
    alert('Admin account created successfully! Please login with the new credentials.')
    showAdminCreation.value = false
    ...
    adminError.value = error.response?.data?.message || 'Failed to create admin account'
  } finally {
